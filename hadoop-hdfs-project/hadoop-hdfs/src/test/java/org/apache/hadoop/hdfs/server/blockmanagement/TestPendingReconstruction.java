...
public class TestPendingReconstruction {
  ...
  public void testPendingReconstruction() {
    ...
    assertEquals(10, pendingReconstructions.size(), "Size of pendingReconstruction ");
    ...
    assertEquals(7, pendingReconstructions.getNumReplicas(blk), "pendingReconstructions.getNumReplicas ");
