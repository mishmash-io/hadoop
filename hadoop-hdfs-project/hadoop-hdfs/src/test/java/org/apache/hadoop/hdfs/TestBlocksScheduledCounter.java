...
public class TestBlocksScheduledCounter {
  ...
  public void testScheduledBlocksCounterShouldDecrementOnAbandonBlock()
    ...
    for (DatanodeDescriptor descriptor : dnList) {
      assertEquals(0, descriptor.getBlocksScheduled(), "Blocks scheduled should be 0 for " + descriptor.getName());
    }
    ...
    for (DatanodeDescriptor descriptor : dnList) {
      ...
      assertEquals(1, descriptor.getBlocksScheduled(), "Blocks scheduled should be 1 for " + descriptor.getName());
    }
    // close the file and the counter should go to zero.
    out.close();
    for (DatanodeDescriptor descriptor : dnList) {
